...
map.getView().fit([-86.203869, -18.878074, -60.436156, 0.409137], map.getSize());
    ...
    element: (() => {
        ...
        if (111 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Este mapa fue elaborado para el curso Cartografia y SIG<br />UPN-2025<br />Estudiante Persybal Alexis Huachaca Juscamaita';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_bd_capa_eventos_union_tabularpoblacionperu_1,
    colName: 'NOMBDEP',
    zoom: 10,
    collapsed: true,
    map: map
